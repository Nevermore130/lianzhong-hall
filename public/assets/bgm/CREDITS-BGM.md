...
本项目使用的所有背景音乐均为 CC0（公共领域）授权，可自由使用、修改和分发。
...
CC0（Creative Commons Zero）是一种公共领域工具，创作者通过它放弃了其作品的所有版权和相关权利。
这意味着您可以：
- 自由复制、修改、分发和表演作品
- 用于商业目的
- 无需署名（虽然仍然建议这样做）

更多信息请访问：https://creativecommons.org/publicdomain/zero/1.0/
